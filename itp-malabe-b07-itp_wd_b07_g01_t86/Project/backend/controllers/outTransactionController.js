...
const outTransacttionModel = mongoose.model('outTransaction', outTransActionSchema);
        ...
        if (req.logInfo.userType == 'admin') {
            if (req.logInfo.userObject.privileges.includes('finance')) {
                ...
                outTransacttionModel
                    ...
                    .catch((err) => {
                        res.status(500).json({ message: 'Error getting total outTransactions' });
                    });
            }
        }
    }
